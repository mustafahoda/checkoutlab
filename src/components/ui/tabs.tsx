...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "border-[1px] border-border rounded-md bg-accent inline-flex items-center justify-center",
      className
    )}
    {...props}
  />
